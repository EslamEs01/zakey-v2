...
**One business input is outstanding and is deliberately not a blocker**: real shipping rates and the installation fee (ASM-004/005). They are modelled as staff-configurable, seeded with clearly-labelled development placeholders, and gated before launch by T-2006. Implementation can proceed without them; **launch cannot**.
